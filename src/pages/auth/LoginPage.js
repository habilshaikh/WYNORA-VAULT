  ...
  return (
    <div className="min-h-screen bg-vault-black flex">
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 relative">
        ...
        >
          <Link to="/" className="inline-flex mb-8" data-testid="navbar-logo">
            <motion.div whileHover={{ scale: 1.03 }} transition={{ duration: 0.25, ease: 'easeOut' }}>
              <BrandWordmark
                // className="border-[#3A4D6A] bg-[#2A3957] shadow-[0_8px_20px_rgba(8,12,22,0.45)]"
                iconClassName="h-7 w-7"
                textClassName="text-[13px] tracking-[0.16em]"
              />
            </motion.div>
          </Link>
