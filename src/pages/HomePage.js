              ...
              >
                <Link to="/signup" className="w-full sm:w-auto">
                  <button
                    ...
                    className="group relative w-full sm:w-auto px-8 py-4 rounded-full font-semibold text-base lg:text-lg overflow-hidden transition-all duration-300 hover:scale-105"
                    style={{
                ...
                <Link to="/how-it-works" className="w-full sm:w-auto">
                  <button
                    ...
                    className="group w-full sm:w-auto px-8 py-4 rounded-full font-semibold text-base lg:text-lg bg-white/5 backdrop-blur-xl border border-[#C8D0DC]/25 text-[#C8D0DC] hover:border-[#D4AF37]/40 hover:bg-[#D4AF37]/5 hover:text-[#E3B82A] transition-all duration-300 hover:shadow-[0_0_30px_rgba(212,175,55,0.15)]"
                  >
                    See How It Works
                  </button>
                </Link>
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h2 className="font-heading text-4xl md:text-5xl lg:text-5xl font-bold text-white mb-4">
